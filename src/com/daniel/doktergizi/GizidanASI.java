...
public class GizidanASI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String p5 = "     Manfaatnya: Sebagai laxantia yang baik untuk membersihkan selaput usus bayi yang baru lahir sehingga saluran pencernaan siap untuk menerima makanan Kadar protein, terutama Globulin (Gamma Globulin) tinggi sehingga dapat memberikan daya perlindungan terhadap infeksi Mengandung zat anti infeksi lain (antibodies) sehingga mampu melindungi bayi thd berbagai infeksi untuk jangka waktu sampai 6 bulan";
		...
		String p9 = "  1. Laktosa pada ASI lebih tinggi dibanding susu sapi, dan mengandung faktor polisakarida laktobasilus bifidus yg menjadi faktor pertumbuhan laktobasilus di usus yang berfungsi mencegah infeksi.";
